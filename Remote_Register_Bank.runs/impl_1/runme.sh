...
HD_PWD='C:/Users/user/Documents/GitHub/Remote_Register_Bank/Remote_Register_Bank.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_reg_bank_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_reg_bank_top.tcl -notrace
