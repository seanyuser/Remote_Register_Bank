...
HD_PWD='C:/Users/user/Documents/GitHub/Remote_Register_Bank/Remote_Register_Bank.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_reg_bank_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_reg_bank_top.tcl
