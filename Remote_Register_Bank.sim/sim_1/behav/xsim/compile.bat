...
REM
REM Generated by Vivado on Sun Nov 02 16:07:56 +0900 2025
...
echo "xvlog --incr --relax -prj tb_uart_reg_bank_top_vlog.prj"
call xvlog  --incr --relax -prj tb_uart_reg_bank_top_vlog.prj -log xvlog.log
